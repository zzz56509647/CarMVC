#pragma checksum "F:\实训1\MvcCarCar\CarMVC\CarMVC\Views\yyhCar\OrdersShow.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a1afe9b09414763fb070d22610734f5cf8638b6d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a1afe9b09414763fb070d22610734f5cf8638b6d", @"/Views/yyhCar/OrdersShow.cshtml")]
    ...
    public class Views_yyhCar_OrdersShow : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "F:\实训1\MvcCarCar\CarMVC\CarMVC\Views\yyhCar\OrdersShow.cshtml"
...
<script>
    ...
    function Show1(page) {
      ...
      ");
            WriteLiteral(@"                  + '<td>' + this.Oid + '</td>'
                        ...
                        + '<td>' + (this.Hitch == 1 ? """" : ""<input id='Button1' type='button' value='报修原因' class='btn btn-danger' onclick=GetBreakdown("" + this.BreakdownID + "") />"" + '&nbsp;' + ""<input id='Button1' type='button' value='报修通过' class='btn btn-success' onclick=UptAgree("" + this.OrdersID ");
            WriteLiteral(@"+ "") />"" + '&nbsp;' + ""<input id='Button1' type='button' value='有待商议' onclick=UptDisAgree("" + this.OrdersID + "") />"")
                        + '</td>'
                        + '</tr>';
                    $(""#tb"").append(line);
                })
    ...
    function UptDisAgree(id) {
        $.ajax({
            url: 'http://localhost:57894/api/Admins3/' + ");
            WriteLiteral(@"id,
            type: 'put',
            dataType: 'json',
            crossDomain: true,
